...
<title>Assignments Regarding your Search</title>
...
<header class="masthead text-white text-center">
      ...
      <div class="container">
        <div class="row">
          ...
          <center>
<form  method="get" action="sampleread">
    <table>
    <tr>
    <td>Enter paper Id</td>
    <td>
    <input type="text" name="bookId" />
    </td>
    </tr>
    <tr>
    <td colspan="2">  <input  type="submit"  value="Get Sample Paper" /></td></tr>
    </table>
</form></center>
         </div>
         </div>
...
<form method="post">
<h1><span class="blue"></span>Assignment<span class="blue"></span> <span class="yellow">Paper</span></h1>
...
ResultSet rs=stmt.executeQuery("select * from c3s.assignment where  department LIKE '%"+dep+"%' and name LIKE '%"+n+"%'");
//PreparedStatement ps = conn.prepareStatement("select id,department,name from c3s.sample where department = ? and name=?");    
//ps.setString(1, dep);
//ps.setString(2, n);
