...
<title>Sample paper Regarding your Search</title>
...
<form method="post">
<h1><span class="blue"></span>Sample<span class="blue"></span> <span class="yellow">Paper</span></h1>
...
ResultSet rs=stmt.executeQuery("select * from c3s.sample where  department LIKE '%"+dep+"%' and name LIKE '%"+n+"%'");
